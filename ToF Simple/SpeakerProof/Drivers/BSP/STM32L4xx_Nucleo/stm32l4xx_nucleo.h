...
#define BUS_USART1_TX_GPIO_PORT GPIOG
#define BUS_USART1_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define BUS_USART1_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOG_CLK_DISABLE()
#define BUS_USART1_TX_GPIO_AF GPIO_AF7_USART1
#define BUS_USART1_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define BUS_USART1_RX_GPIO_PORT GPIOG
#define BUS_USART1_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOG_CLK_DISABLE()
